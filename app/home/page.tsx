        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                あなたを虜にする、妖艶なキャストをご紹介
              </p>
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {[1, 3, 4].map((castId, index) => {
                const cast = castMembers.find(c => c.id === castId);
                if (!cast) return null;
                  ...
                  >
                    <div className="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4 shadow-lg">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        ...
                        <p className="text-xs text-gray-300">{cast.age}歳 / {cast.bodyType}</p>
                      </div>
                    </div>
                    <div className="text-center">
                      ...
                      {cast.category.includes("新人") && (
                        <p className="text-sm text-primary-600 font-medium">NEW FACE</p>
                      )}
                      {cast.category.includes("人気") && !cast.category.includes("新人") && (
                        <p className="text-sm text-primary-600 font-medium">人気</p>
                      )}
                    </div>
                  </motion.div>
                );
            ...
            >
              <Link href="/cast">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-10 py-4 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 text-lg"
                >
                  すべてのキャストを見る
                </motion.button>
              </Link>
