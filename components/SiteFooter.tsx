        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="flex gap-6 text-sm text-gray-500">
              ...
              <Link href="/terms" className="hover:text-pink-500">利用規約</Link>
              <Link href="/privacy" className="hover:text-pink-500">プライバシーポリシー</Link>
            </nav>
          </div>
          <Image src="/images/18ng.png" alt="18歳未満禁止" width={50} height={50} />
        </div>
        <p className="text-center text-xs text-gray-400 mt-6">© 2024 アイブランド帯広. All rights reserved.</p>
      </div>

      {/* モバイル版フッター */}
      <div className="md:hidden p-4">
        <div className="text-center space-y-3">
          <Image src="/images/logo.png" alt="アイブランド帯広" width={120} height={36} className="mx-auto" />
          <nav className="flex justify-center gap-4 text-[10px] text-gray-500">
            <Link href="/home" className="hover:text-pink-500">TOP</Link>
            <Link href="/cast" className="hover:text-pink-500">キャスト</Link>
            <Link href="/system" className="hover:text-pink-500">料金</Link>
            <Link href="/info" className="hover:text-pink-500">店舗情報</Link>
          ...
          <p className="text-[9px] text-gray-400">© 2024 アイブランド帯広. All rights reserved.</p>
