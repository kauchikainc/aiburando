    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="hidden md:block">
        ...
        <section className="relative py-16 bg-gradient-to-b from-pink-50 to-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h1 className="text-4xl font-heading font-bold text-gray-800 mb-2">
              <span className="text-pink-500">店舗</span>情報
            </h1>
            <p className="text-gray-500">安心してご利用いただくための詳細情報</p>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                  <div className="p-4 border-b border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 text-xl font-bold">アイブランド帯広</p>
                    </div>
                  </div>
                  <div className="p-4 border-b border-gray-100 flex items-center gap-4">
                    <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-pink-500 text-xl font-bold">10:00〜翌5:00</p>
                      <p className="text-gray-400 text-xs">年中無休</p>
                    </div>
                  </div>
                  <div className="p-4 border-b border-gray-100 flex items-center gap-4">
                    <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <a href="tel:0120-XXX-XXX" className="text-gray-800 text-xl font-bold hover:text-pink-500">0120-XXX-XXX</a>
                      <p className="text-gray-400 text-xs">通話料無料</p>
                    </div>
                  </div>
                  <div className="p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded text-sm">現金</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* 右カラム: 対応エリア */}
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6">対応エリア</h2>
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-bold text-lg mb-1">帯広市全域</p>
                      <p className="text-gray-500 text-sm">出張対応いたします</p>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-400 text-xs mt-4">※その他エリアもご相談ください</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 text-center mb-8">ご利用の流れ</h2>
            <div className="grid grid-cols-4 gap-6">
              {steps.map((item, index) => (
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="bg-white rounded-xl p-6 text-center border border-gray-200 shadow-sm h-full">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-gray-800 text-center mb-8">ご利用にあたって</h2>
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
      ...
      <main className="md:hidden">
        ...
        <section className="bg-gradient-to-b from-pink-50 to-white py-6 px-4 text-center">
          ...
          <p className="text-xs text-gray-500">安心してご利用いただくための詳細情報</p>
        </section>

        {/* 基本情報 */}
        <section className="bg-white py-4 px-3">
          <h2 className="text-gray-800 font-bold text-sm mb-3">基本情報</h2>
          <div className="bg-gray-50 rounded-lg overflow-hidden border border-gray-200">
            <div className="p-3 border-b border-gray-200 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold">アイブランド帯広</p>
              </div>
            </div>
            <div className="p-3 border-b border-gray-200 flex items-center gap-3">
              <div className="w-10 h-10 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-pink-500 font-bold">10:00〜翌5:00</p>
              </div>
            </div>
            <div className="p-3 border-b border-gray-200 flex items-center gap-3">
              <div className="w-10 h-10 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold">帯広市全域</p>
              </div>
            </div>
            <div className="p-3 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold text-sm">現金</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-4 px-3">
          <h2 className="text-gray-800 font-bold text-sm mb-3">ご利用の流れ</h2>
          <div className="space-y-3">
            {steps.map((item, index) => (
              <div key={index} className="bg-white rounded-lg p-3 flex items-center gap-3 border border-gray-200">
                ...
                <div>
                  <p className="text-gray-800 font-bold text-sm">{item.title}</p>
        ...
        {/* 注意事項 */}
        <section className="bg-white py-4 px-3">
          <h2 className="text-gray-800 font-bold text-sm mb-3">ご利用にあたって</h2>
