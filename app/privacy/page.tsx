      ...
      <main>
        <section className="py-12 md:py-20 bg-gradient-to-b from-pink-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-heading font-bold text-gray-800 mb-8">
                プライバシーポリシー
              </h1>

              <div className="space-y-4 md:space-y-6">
                <div className="bg-white rounded-xl p-6 md:p-8 border border-gray-200 shadow-sm">
                  <h2 className="text-xl md:text-2xl font-heading font-bold text-pink-500 mb-4">
                    個人情報の取り扱いについて
                  </h2>
                ...
                <div className="bg-white rounded-xl p-6 md:p-8 border border-gray-200 shadow-sm">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 text-sm md:text-base">
                    <li>サービスのご提供のため</li>
                ...
                <div className="bg-white rounded-xl p-6 md:p-8 border border-gray-200 shadow-sm">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <p className="text-gray-800 font-bold">電話番号: 0120-XXX-XXX</p>
                    <p className="text-gray-500 text-sm mt-1">受付時間: 24時間対応</p>
                  </div>
                </div>
              </div>
            </motion.div>
